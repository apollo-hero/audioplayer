					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Terms & Conditions</span>
							</div>
						...
						<div class="portlet-body form">
							...
							<?php
								 ...
								 $attributes = array('class' => 'form-horizontal', 'id' => 'form_terms_and_conditions');
								 $form_action = "admin/terms_and_conditions";
								...
								<div class="form-group">
									...
									* </span>
									...
									<div class="col-md-10">        
										...
										<textarea class="ckeditor form-control" rows="6" name="terms_conditions" id="terms_conditions" data-error-container="#editor1_error"><?php if(set_value('terms_conditions')){echo set_value('terms_conditions');}elseif(isset($content_management)){echo $content_management[0]['terms_conditions'];}?></textarea>
