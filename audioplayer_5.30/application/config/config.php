...
|
 */
$PitServe = "http://" . $_SERVER['HTTP_HOST'];
$PitServe .= str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']);
$config['base_url'] = $PitServe;
...
// $config['base_url']    = 'localhost/PitServe';
...
// Replace it with your .pem file name and password
$config['IS_WEB_LIVE'] = false;
$config['PUSH_LIVE_NAME'] = "";
$config['PUSH_LIVE_PASSPHRASE'] = "";

$config['PUSH_DEV_NAME'] = "pushcert_dev.pem";
$config['PUSH_DEV_PASSPHRASE'] = "1234";
